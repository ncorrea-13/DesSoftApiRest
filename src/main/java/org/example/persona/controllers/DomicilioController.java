...
public class DomicilioController {
    ...
    @PostMapping("")
    public ResponseEntity<?> save(@RequestBody Domicilio entity) throws Exception {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody Domicilio entity) throws Exception {
        try {
